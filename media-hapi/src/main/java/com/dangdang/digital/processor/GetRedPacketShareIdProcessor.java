...
/**
 * Description:获取红包的分享id接口
 * All Rights Reserved.
 * @version 1.0  2014年12月9日 下午5:17:41  by 周伟洋（zhouweiyang@dangdang.com）创建
 */
@Component("hapigetRedPacketShareIdprocessor")
public class GetRedPacketShareIdProcessor extends BaseApiProcessor {

	private static final Logger LOGGER = LoggerFactory.getLogger(GetRedPacketShareIdProcessor.class);
