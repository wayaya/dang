...
public interface IActivityRecordService extends IBaseService<ActivityRecord, Long> {
	 ...
	 * @return
	 */
	List<ActivityRecord> selectUserActivityRecord(Long custId,int activityType,int prizeType,int start,int count);
	...
	/**
	 * Description:  根据类型获取用户的活动记录的总量
	 * @Version1.0 2014年12月13日 下午4:33:39 by 周伟洋（zhouweiyang@dangdang.com）创建
	 * @param custId
	 * @param activityType
	 * @return
	 */
