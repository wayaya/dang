...
public class ActivityRecordServiceImpl extends BaseServiceImpl<ActivityRecord, Long> implements IActivityRecordService{
	...
	@Override
	public List<ActivityRecord> selectUserActivityRecord(Long custId,int activityType,int prizeType,int start,int count) {
		return activityRecordDao.selectUserActivityRecord(custId, activityType,prizeType,start,count);
	}
