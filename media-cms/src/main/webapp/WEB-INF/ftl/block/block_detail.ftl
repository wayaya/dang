		...
		<div class="main clear"><!--main开始-->
			<div class="right" style="width:99%;">
				<div class="m-r">
				    ...
				    <div>
					    <form action="/block/add.go" method="post" id="add_form" enctype="multipart/form-data">
						     ...
						     <table class="table3" border="1" bordercolor="#a0c6e5" rules="none">
					     	    <tr>
					    			<td class="tdright">块名称：</td><td><input type="text" name="name" readonly="readonly" id="name" value="<#if block??><#if block.name??>${block.name}</#if></#if>"></td><td style="width:1100px;text-align:left" id="nameInfo"  name="messageInfo"></td>
						      	</tr>
						      	<tr>
					    			<td class="tdright">标识：</td><td><input type="text" readonly="readonly" value="<#if block??><#if block.code??>${block.code}</#if></#if>" name="code" id="code"></td><td style="width:1100px;text-align:left" id="codeInfo" name="messageInfo"></td>
						      	</tr>
						      	<tr>
						      	...
						      	<tr style="height: 80px;">
					    			...
					    			<td colspan="2" style="text-align:left">
					    				<#if block??><#if block.picPath??><img src="${block.picPath}" width="500" height="80"/></#if></#if>
					    			</td>
						      	</tr>
								...
								<tr>
					    			...
					    			<td colspan=2><textarea name="content" id="content" style="width: 709px; height: 193px; float: left;"><#if block??><#if block.content??>${block.content}</#if></#if> </textarea></td>
						      	</tr>
				            </table>
			            </form>
		            </div>
