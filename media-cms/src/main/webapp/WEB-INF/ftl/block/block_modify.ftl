		...
		<div class="main clear"><!--main开始-->
			<div class="right" style="width:99%;">
				<div class="m-r">
				    ...
				    <div>
					    <form action="/block/update.go" method="post" id="add_form" enctype="multipart/form-data">
					    	...
					    	<input type="hidden" name="picPath" value="<#if block??><#if block.picPath??>${block.picPath}</#if></#if>">
						     <table class="table3" border="1" bordercolor="#a0c6e5" rules="none">
					     	    <tr>
						      	...
						      	<tr>
					    			<td class="tdright">标识：</td><td><input type="text" value="<#if block??><#if block.code??>${block.code}</#if></#if>" name="code" id="code"  onblur="checkCode(this.value)"></td><td style="width:1100px;text-align:left" id="codeInfo" name="messageInfo"></td>
						      	</tr>
						      	<tr>
						      	...
						      	<#if block??><#if block.picPath??>
						      	<tr style="height: 80px;">
					    			<td class="tdright">(原)主图：</td>
					    			<td colspan="2" style="text-align:left">
					    				<img src="${block.picPath}" width="500" height="80"/>
					    			</td>
						      	</tr>
							    </#if></#if>
