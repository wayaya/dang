	...
	<script type="text/javascript">	
		...
		$(function(){
			$('.pagination').pagination(${pageFinder.rowCount?c}, {
				...
				link_to: encodeURI('/consumerDeposit/abnormalList.go?page=__id__'+"&"+$("#master_list_form").serialize())
		    });
		...
		function searchMaster(){
	   	...
	   	function showDetail(consumerDepositId){
	   		$.dialog({title:'充值记录详情页',content:'url:/consumerDeposit/abnormalDetail.go?consumerDepositId='+consumerDepositId,
	   		icon:'succeed',width:800,height:500,fixed:false,lock:true,id: 'abnormalDetail',zIndex:1976,cancel:function(){searchMaster();}});
	   	}
  ...
  <body>
	 <div class="page"><!--page开始-->
			...
			<div class="right">
				...
				<h3>充值管理&gt;&gt;异常充值记录列表</h3>
				<div class="mrdiv">
		      		<form action="/consumerDeposit/abnormalList.go" method="post" id="master_list_form">
		      			<table>	      		
							...
							<tr style="height:30px;">
								...
								<td style="text-align:left">
							 	...
							 	<td style="text-align:right">平台来源：</td>
								<td style="text-align:left">
								...
								<td style="text-align:right"><button  onclick="return searchMaster()">&nbsp;&nbsp;查&nbsp;询&nbsp;&nbsp;</button></td>
