...
<head>
	...
	$(document).ready(function(){
			$('#addBtn').click(function(){
				$.dialog({
					title:'封面图展示',
					content:"url:/epubImage/list.go?mediaId=${dis.mediaId?c}",
			   		icon:'succeed',
			   		width:500,
			   		height:150,
			   		fixed:false,
		...
		function reset(){
	   	...
	   	function activityTypeAddForm(){
	   		...
	   		var len = $("input[name='signs']:checked").length; 
			if(len>3) { 
				alert("最多选择三个标签！"); 
				flag= false; 
			}else { 
		...
		<div class="main clear"><!--main开始-->
			<div class="right">
				<div class="m-r">
				    ...
				    <div>
					    <form action="/epub/save.go" method="post" id="activity_type_add_form" enctype="multipart/form-data">
					    ...
					    <input type="hidden" id="type" name="type" value=1>
						     <table class="table3" border="1" bordercolor="#a0c6e5" rules=none>
			    				<tr id="cardTitleTr">
					    			...
					    			value="<#if dis??><#if dis.title??>${dis.title}</#if></#if>" name="cardTitle" id="cardTitle" onblur="validInput('cardTitle')">
						      	...
						      	<tr>
					    			<td><font color="red">*</font>作者：</td><td class="tdleft"><input style="width:250px" type="text" 
					    			  value="<#if dis??><#if dis.author??>${dis.author}</#if></#if>" name="author" id="author" onblur="validInput('author')">&nbsp;&nbsp;<span id="authorPennameInfo"></span>(<font color="red">*</font>添加多位作者请用，隔开)</td><td style="width:1100px" id=""></td>
						      	</tr>
						      	<tr>
						        ...
						        <tr>
					    			<td>当当电子书ID：</td><td class="tdleft"><input type="text"  value="<#if dis??><#if dis.mediaId??>${dis.mediaId?c}</#if></#if>" name="mediaId" id="mediaId">&nbsp;&nbsp;<span id="mediaIdInfo"></span></td><td style="width:1100px" id=""></td>
						      	</tr>
						      	<tr>
						      	<td class="left_table_tr_td" heigth="28px" width="25%">
							 	评星：
							 	<td><div style="text-align:left"><select name="stars" id="stars" style="width:50%" text-align:left>
								...
								<td>
						      	...
						      	<tr  id="cardRemarkTr" style="display:none;">
					    			<td><font color="red">*</font>卡片摘要：</td>
					    			<td class="tdleft">
						    			<textarea cols=80 rows=10 name="cardRemark" id="cardRemark" onblur="validInput('cardRemark')"><#if chapter??><#if chapter.desc??>${chapter.desc}</#if></#if></textarea>
						    			&nbsp;&nbsp;<span id="cardRemarkInfo"></span>
						    			<span id="contentNum"></span>
					    			</td>
					    			<td style="width:1100px" id=""></td>
						      	</tr>
						      	<tr  class="pic1PathTr" style="display:none;">
						      	
					    			<td><font color="red">*</font>请输入封面图地址：</td>
					    			<td class="tdleft">
					    				<input id="pic1Path" type="text" name="pic1Path" value="<#if dis??><#if dis.pic1Path??>${dis.pic1Path}</#if></#if>">
					    				<button type="button" id="addBtn" >查看封面图</button>
						      		</td>
						      	</tr>
						      	<tr class="pic1PathTr">
