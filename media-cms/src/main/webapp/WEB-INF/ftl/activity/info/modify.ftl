...
<head>
	...
	<script type="text/javascript">
		...
		function calculateDiscount(){
	   	...
	   	function activityInfoModifyForm(){
	   		var reg1 =  /^\d+$/;
	   		var flag = true;
  ...
  <body>
	 <div class="page"><!--page开始-->
		<div class="main clear"><!--main开始-->
			<div class="right">
				<div class="m-r">
					<h3><a href="/activity/info/list.go">促销信息管理</a>&nbsp;&gt;&gt;&nbsp;修改促销信息</h3>
					<#if returnInfo??>
						<div class="mrdiv">
				      		 <table >
			        			<tr>
									<td style="padding-left:50px;"><span id="message">${returnInfo}</span>
										<#if successFlag??>
					    					<#if successFlag == 0>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/activity/info/modify.go?activityId=<#if activityInfo??><#if activityInfo.activityId??>${activityInfo.activityId?c}</#if></#if>" style="height: 20px; font-size: 20px;"><image src="/images/continue_modify.png"/></a>&nbsp;&nbsp;<a href="/activity/info/list.go" style="height: 20px; font-size: 20px;"><img src='/images/show_list.jpg' style='padding-bottom: 0px;'></a></#if>
					    				</#if>
									</td>
								</tr>
							</table>
				    ...
				    <div>
					    <form action="/activity/info/gomodify.go" method="post" id="activity_type_modify_form">
						     ...
						     <table class="table3" border="1" bordercolor="#a0c6e5" rules=none>
			    				<tr>
						      	...
						      	<tr id="previous_number_give">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="isPreviousNumber" onblur="validInputMustNumber('isPreviousNumber')" id="isPreviousNumber" value="<#if activityInfo??><#if activityInfo.isPreviousNumber??>${activityInfo.isPreviousNumber}</#if></#if>"></td>
						      	...
						      	<tr id="give_scale">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="giveScale" onblur="validInputMustNumber('giveScale')" id="giveScale" value="<#if activityInfo??><#if activityInfo.giveScale??>${activityInfo.giveScale}</#if></#if>"></td>
						      	...
						      	<tr id="consume_give">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="consumeSatisfy" onblur="validInputMustNumber('consumeSatisfy')" id="consumeSatisfy" value="<#if activityInfo??><#if activityInfo.consumeSatisfy??>${activityInfo.consumeSatisfy}</#if></#if>"></td>
						      	...
						      	<tr id="consume_level_give">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="giveGoldPiece" onblur="validInputMustNumber('giveGoldPiece')" id="giveGoldPiece" value="<#if activityInfo??><#if activityInfo.giveGoldPiece??>${activityInfo.giveGoldPiece}</#if></#if>"></td>
						      	...
						      	<tr id="day_worship_give_1">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="dayWorshipLimit" onblur="validInputMustNumber('dayWorshipLimit')" id="dayWorshipLimit" value="<#if activityInfo??><#if activityInfo.dayWorshipLimit??>${activityInfo.dayWorshipLimit}</#if></#if>"></td>
						      	...
						      	<tr id="day_worship_give_2">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="lowestGoldPiece" onblur="validInputMustNumber('lowestGoldPiece')" id="lowestGoldPiece" value="<#if activityInfo??><#if activityInfo.lowestGoldPiece??>${activityInfo.lowestGoldPiece}</#if></#if>"></td>
					    			<td class="tdleft"  style="width:8%"  id="lowestGoldPieceInfo" name="messageInfo"></td>
					    			<td class="tdright" style="width:15%">每次膜拜最多奖励金币：</td>
					    			<td class="tdleft" style="width:10%"><input type="text" name="highestGoldPiece" onblur="validInputMustNumber('highestGoldPiece')" id="highestGoldPiece" value="<#if activityInfo??><#if activityInfo.highestGoldPiece??>${activityInfo.highestGoldPiece}</#if></#if>"></td>
						      	...
						      	<tr id="monthly_payment_2">
					    			...
					    			<td class="tdleft" style="width:10%">
					    				<select id="monthlyBuyOrGive" name="monthlyBuyOrGive" onchange="validInput('monthlyBuyOrGive')">
					    					...
					    					<option value="1" <#if activityInfo??><#if activityInfo.monthlyBuyOrGive??><#if activityInfo.monthlyBuyOrGive==1>selected="selected"</#if></#if></#if>>赠送</option>
					    				</select>
					    			</td>
					    		...
					    		<tr id="discount_info">
					    			<td class="tdright" style="width:15%">打折比例：</td><td><input type="text" onblur="validInputMustNumber('discount')" name="discount" id="discount" value="<#if activityInfo??><#if activityInfo.discount??>${activityInfo.discount?c}</#if></#if>"></td><td class="tdleft" style="width:8%"  id="discountInfo" name="messageInfo"></td>
					    			<td style="width:15%">&nbsp;</td>
					    			<td style="width:10%">&nbsp;</td>
					    			<td style="width:8%">&nbsp;</td>
					    			<td style="width:15%">&nbsp;</td>
					    		...
					    		<tr id="prize">
					    			...
					    			<td class="tdleft" style="width:10%"><input type="text" name="prizeQuantity" onblur="validInputMustNumber('prizeQuantity')" id="prizeQuantity" value="<#if activityInfo??><#if activityInfo.prizeQuantity??>${activityInfo.prizeQuantity?c}</#if></#if>"></td>
					    			<td class="tdleft"  style="width:8%"  id="prizeQuantityInfo" name="messageInfo"></td>
					    			<td class="tdright" style="width:15%">福袋购买金额：</td>
					    			<td class="tdleft" style="width:10%"><input type="text" name="prizePrice" onblur="validInputMustNumber('prizePrice')" id="prizePrice" value="<#if activityInfo??><#if activityInfo.prizePrice??>${activityInfo.prizePrice?c}</#if></#if>"></td>
						      	...
						      	<tr id="deposit_2">
						      		<td class="tdright" style="width:15%">赠送阅读币个数：</td>
					    		...
					    		<tr id="deposit_3">
						      	...
						      	<tr>
					    			<td colspan="9" style="text-align:center;">
					    				<#if successFlag??>
					    					<#if successFlag == 1><image src="/images/save.jpg" onclick="javascript:activityInfoModifyForm()" /></#if>
					    				<#else>
					    					<image src="/images/save.jpg" onclick="javascript:activityInfoModifyForm()" />
