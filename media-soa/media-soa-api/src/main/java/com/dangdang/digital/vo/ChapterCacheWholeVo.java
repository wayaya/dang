...
/**
 * 
 * Description: 章节缓存wholevo All Rights Reserved.
 * 
 * @version 1.0 2014年12月6日 下午6:47:31 by 许文轩（xuwenxuan@dangdang.com）创建
 */
public class ChapterCacheWholeVo implements Serializable {

	private static final long serialVersionUID = -1337068555117230250L;
