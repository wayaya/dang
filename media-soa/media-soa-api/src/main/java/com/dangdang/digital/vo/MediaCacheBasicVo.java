...
/**
 * 
 * Description: media缓存，包含基本字段 All Rights Reserved.
 * 
 * @version 1.0 2014年12月6日 上午11:01:29 by 许文轩（xuwenxuan@dangdang.com）创建
 */
public class MediaCacheBasicVo implements Serializable {

	private static final long serialVersionUID = 4410682219822439626L;
